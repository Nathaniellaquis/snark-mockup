    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black mb-2 tracking-tight">Join the waitlist</h1>
            ...
            <form className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label variant="snark" htmlFor="firstName">
                    First Name
                  </Label>
                  <Input
                    variant="snark"
                ...
                <div className="space-y-2">
                  <Label variant="snark" htmlFor="lastName">
                    Last Name
                  </Label>
                  <Input
                    variant="snark"
              ...
              {/* Age Confirmation */}
              <div className="flex items-start gap-3 p-4 bg-violet-600/10 border border-violet-500/30 rounded-lg">
                <Checkbox variant="snark" id="age" />
                <div className="space-y-1">
                  <Label variant="snark" htmlFor="age" className="cursor-pointer">
                    I confirm I am 18 years or older
                  </Label>
                  <p className="text-xs text-gray-400">
                    Snark is only available to adults
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <Checkbox variant="snark" id="terms" />
                <Label variant="snarkGray" htmlFor="terms" className="cursor-pointer text-sm">
                  I agree to the{" "}
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <a href="/login" className="text-violet-400 hover:text-violet-300 font-semibold underline">
            Sign in
          </a>
        </p>
        ...
        <div className="flex items-center justify-center gap-4 mt-8">
          ...
          <Badge variant="snarkViolet" className="text-xs px-3 py-1">
            ✓ Privacy First
          </Badge>
          <Badge variant="snarkGhost" className="text-xs px-3 py-1">
            ✓ 24/7 Support
          </Badge>
        </div>
      </div>
